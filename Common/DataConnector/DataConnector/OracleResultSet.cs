...
namespace Amellar.Common.DataConnector
{
    ...
    public class OracleResultSet
    {
        ...
        */
        ...
        public void CreateNewConnectionGIS()
        {
            int intPort = 0;
        ...
        public void CreateNewConnectionRPTA()
        {
            int intPort = 0;
            ...
            this.CreateInstance(objOracleDataConn.Connection);
        }//MCR 20140812 create RPTA connection
        ...
        //MCR 20150121 create ARCS connection
        public void CreateNewConnectionARCS()
        {
            int intPort = 0;
            int.TryParse(System.Configuration.ConfigurationManager.AppSettings["ARCSPort"], out intPort);
            objOracleDataConn = new OracleDataConnector(
                       System.Configuration.ConfigurationManager.AppSettings["ARCSHost"],
                       intPort,
                       System.Configuration.ConfigurationManager.AppSettings["ARCSServiceName"],
                       System.Configuration.ConfigurationManager.AppSettings["ARCSUserId"],
                       System.Configuration.ConfigurationManager.AppSettings["ARCSPassword"]
                                            );
